...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="/content/LPRnet/dataset/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="/content/LPRnet/dataset/test", help='the test images path')
    ...
    parser.add_argument('--save_folder', default='/content/LPRnet/weights', help='Location to save checkpoint models')
