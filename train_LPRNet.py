...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="/content/LPRNet_PyTorch/dataset/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="/content/LPRNet_PyTorch/dataset/test", help='the test images path')
    ...
    parser.add_argument('--train_batch_size', default=7, help='training batch size.')
    parser.add_argument('--test_batch_size', default=5, help='testing batch size.')
    ...
    parser.add_argument('--save_folder', default='/content/LPRNet_PyTorch/weights', help='Location to save checkpoint models')
...
def train():
    ...
    ctc_loss = nn.CTCLoss(blank=5, reduction='mean') # reduction: 'none' | 'mean' | 'sum'
    ...
    for iteration in range(start_iter, max_iter):
        ...
        max_length = log_probs.size(0)
        input_lengths = [max_length] * log_probs.size(1)
